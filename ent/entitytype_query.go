...
func (etq *EntityTypeQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (etq *EntityTypeQuery) FirstIDX(ctx context.Context) int {
...
func (etq *EntityTypeQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (etq *EntityTypeQuery) OnlyIDX(ctx context.Context) int {
...
func (etq *EntityTypeQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (etq *EntityTypeQuery) IDsX(ctx context.Context) []int {
	ids, err := etq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (etq *EntityTypeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(entitytype.Table, entitytype.Columns, sqlgraph.NewFieldSpec(entitytype.FieldID, field.TypeInt))
	_spec.From = etq.sql
